...
Ralio.prototype.addComment = function (itemID, text, callback) {
  var self = this,
      options = {
        url: self.bulkUrl({"pathname":"/slm/webservice/" + this.version + "/conversationpost/create.js"}),
        method: 'POST',
    ...
    self.bulk({
      ...
      if (error !== null) {
        ...
        if (value.length) {
          ...
          var options = {
            url: self.bulkUrl({"pathname":"/slm/webservice/" + this.version + "/timeentryvalue/create.js"}),
            method: 'POST',
            json: {"TimeEntryValue":{
              "Project": project,
              "TimeEntryItem": item,
          ...
          if (error !== null) {
            ...
            if (item.length) {
              ...
              var itemCreation = setInterval(function() {
                ...
                var options = {
                  url: self.bulkUrl({"pathname":"/slm/webservice/" + this.version + "/timeentryitem/create.js"}),
                  method: 'POST',
                  json: {"TimeEntryItem":{
                    "Project": project,
                    "WorkProduct": story,
  ...
  var taskCreation = setInterval(function() {
    if (tagsObject.length === tags.length || Ralio.test) {
      self.story(storyID, function(error, data) {
        ...
        var options = {
          url: self.bulkUrl({"pathname":"/slm/webservice/" + this.version + "/task/create.js"}),
          method: 'POST',
          json: new_task,
          strictSSL: !Ralio.test
        };
